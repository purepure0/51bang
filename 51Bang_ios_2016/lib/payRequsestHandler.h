...
#define APP_ID          @"wx765b8c5e082532b4"               //APPID
//#define APP_SECRET      @"risF2owP8yAdmZgfVYnmqZoElIpD5Bz1" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1364047302"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"risF2owP8yAdmZgfVYnmqZoElIpD5Bz1"
//支付结果回调页面
